...
public class Money implements Comparable {
	...
	public String toString() {
		if (amount == 0) return "0 " + currency.getName();
		return (amount/100) + "." + (amount%100) + " " + currency.getName();
	}
	...
	public Money sub(Money other) {
		return new Money(amount - currency.valueInThisCurrency(other.amount, other.currency), this.currency);
	}
	...
	public int compareTo(Object other) {
		...
		return amount - currency.valueInThisCurrency(otherMoney.amount, otherMoney.currency);
	}
}